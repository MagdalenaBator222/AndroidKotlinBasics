...
class SportsListFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // disable moving to the detail screen by sliding
        ...
        val adapter = SportsAdapter {
            ...
            // Open the "detail" pane instead of navigating to the detail screen
...
class SportsListOnBackPressedCallback (
    private val slidingPaneLayout: SlidingPaneLayout // constructor parameter
        ) : OnBackPressedCallback(slidingPaneLayout.isOpen && slidingPaneLayout.isSlideable),
    SlidingPaneLayout.PanelSlideListener {

    init {
        slidingPaneLayout.addPanelSlideListener(this) // listener for the details pane slide events
    }
